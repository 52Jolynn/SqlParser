...
set_constraints_mode_statement : SET CONSTRAINT constraint_name_list (DEFERRED|IMMEDIATE);
...
:
	...
	| MESSAGE_TEXT|MESSAGE_LENGTH|MESSAGE_OCTET_LENGTH
;
...
language_name : ADA|C_|COBOL|FORTRAN|MUMPS|PASCAL|PLI;
extract_field
:
	datetime_field
	| time_zone_field
